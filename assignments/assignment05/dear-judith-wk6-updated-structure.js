...
class DiaryEntry {
  constructor(obj) {
    ...
    if (obj.entry != null) {
      this.entry = {};
      this.entry.S = obj.entry || 'had nothing to say';
    }
    ...
    if (obj.commentOn != null) {
      this.commentOn = {};
      this.commentOn.NS = typeof obj.commentOn != 'undefined'? [obj.commentOn[0].toString(), obj.commentOn[1].toString()] : '[-1, -1]';
    }
    if (obj.update != null) {
      this.update = {};
      this.update.M = obj.update;
    }
  }
}
...
currentUploadIndex = 0; // x+1, = diaryEntries.length
